...
public class Cell {
	...
	public Cell(int row, int col) {
		...
		// the variables from line 10 initialised as part of the constructor
		this.row = row;
		this.col = col;

		// method from lines 46 - 50 called that sets the content variable (initialised on line 8) to EMPTY
		clear();
	}
	...
	public void clear() {
		// Sets the value of content to Empty (from the Player enum)
